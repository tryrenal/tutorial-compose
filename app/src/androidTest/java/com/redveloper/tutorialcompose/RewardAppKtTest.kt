...
import com.redveloper.tutorialcompose.model.FakeRewardDataSource
...
class RewardAppKtTest{
    ...
    fun setup(){
        composeTestRule.setContent {
            TutorialComposeTheme {
                ...
                RewardApp(navController = navController)
            }
        }
    }
    ...
    fun navhost_clickitem_navigatesToDetailWithData(){
        ...
        composeTestRule.onNodeWithText(
            FakeRewardDataSource.dummyRewards[10].title
        ).performClick()
